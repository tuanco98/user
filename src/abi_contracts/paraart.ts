...
export const Paraart_ABI: AbiItem[] = [
    ...
    {
        anonymous: false,
        inputs: [{ indexed: false, internalType: "bytes32", name: "hashed", type: "bytes32" }],
        name: "Locked",
        type: "event",
    },
    {
    ...
    },
    {
        ...
        name: "changeFreeTempalteAddress",
        outputs: [],
        stateMutability: "nonpayable",
        type: "function",
    },
